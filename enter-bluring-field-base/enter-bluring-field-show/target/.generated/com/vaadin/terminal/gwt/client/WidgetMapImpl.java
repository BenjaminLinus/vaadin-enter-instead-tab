...
public class WidgetMapImpl extends com.vaadin.terminal.gwt.client.WidgetMap {
  public Class<? extends Paintable> getImplementationByServerSideClassName(String fullyQualifiedName) {
    ...
    if ( fullyQualifiedName == "com.vaadin.ui.AbsoluteLayout" ) { ensureInstantiator(com.vaadin.terminal.gwt.client.ui.VAbsoluteLayout.class); return com.vaadin.terminal.gwt.client.ui.VAbsoluteLayout.class;}
    ...
    else if ( fullyQualifiedName == "com.alfrescodev.vaadin.ui.EnterBluringDateField" ) { ensureInstantiator(com.vaadin.terminal.gwt.client.ui.VEnterBluringDateField.class); return com.vaadin.terminal.gwt.client.ui.VEnterBluringDateField.class;}
    ...
    else if ( fullyQualifiedName == "com.alfrescodev.vaadin.ui.EnterBluringCombobox" ) { ensureInstantiator(com.alfrescodev.gwt.client.ui.field.VEnterBluringCombobox.class); return com.alfrescodev.gwt.client.ui.field.VEnterBluringCombobox.class;}
    ...
    else if ( fullyQualifiedName == "com.alfrescodev.vaadin.ui.EnterBluringField" ) { ensureInstantiator(com.alfrescodev.gwt.client.ui.field.VEnterBluringTextField.class); return com.alfrescodev.gwt.client.ui.field.VEnterBluringTextField.class;}
  ...
  if( classType == com.vaadin.terminal.gwt.client.ui.VAbsoluteLayout.class) {instmap.put(com.vaadin.terminal.gwt.client.ui.VAbsoluteLayout.class, new WidgetInstantiator() {
...
);} else if( classType == com.vaadin.terminal.gwt.client.ui.VEnterBluringDateField.class) {instmap.put(com.vaadin.terminal.gwt.client.ui.VEnterBluringDateField.class, new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(com.vaadin.terminal.gwt.client.ui.VEnterBluringDateField.class );
  }
  }
...
);} else if( classType == com.alfrescodev.gwt.client.ui.field.VEnterBluringCombobox.class) {instmap.put(com.alfrescodev.gwt.client.ui.field.VEnterBluringCombobox.class, new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(com.alfrescodev.gwt.client.ui.field.VEnterBluringCombobox.class );
  }
  }
...
);} else if( classType == com.alfrescodev.gwt.client.ui.field.VEnterBluringTextField.class) {instmap.put(com.alfrescodev.gwt.client.ui.field.VEnterBluringTextField.class, new WidgetInstantiator() {
   public Paintable get() {
   return GWT.create(com.alfrescodev.gwt.client.ui.field.VEnterBluringTextField.class );
  }
  }
