...
/**
 * 
 * This is client GWT component for
 * com.alfrescodev.vaadin.field.EnterBluringDateField This component extends
 * com.vaadin.terminal.gwt.client.ui.VPopupCalendar and find and focus next
 * field (on page) every time the user presses enter.
 * 
 * @author Alfrescodev.com
 * 
 */
public class VEnterBluringDateField extends VTextualDate implements Paintable,
	...
	public VEnterBluringDateField() {
		...
		calendar.addDomHandler(new KeyDownHandler() {
